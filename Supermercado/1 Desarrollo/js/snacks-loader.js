...
const rutaPDF = 'Recursos/BD/SNACKL2.pdf'; // archivo fijo

(async function () {
  const imagenDefault = 'images/Snacks.jpg';
    ...
    productos.forEach((p, idx) => {
      ...
      li.innerHTML = `
        ...
        <div class="astra-shop-summary-wrap">
          <span class="ast-woo-product-category">Snacks</span>
