...
const rutaPDF = 'Recursos/BD/BEBIDAS L2.pdf'; // archivo fijo

(async function () {
  const imagenDefault = 'images/Bebidas.png';
    ...
    productos.forEach((p, idx) => {
      ...
      li.innerHTML = `
        ...
        <div class="astra-shop-summary-wrap">
          <span class="ast-woo-product-category">Bebidas</span>
