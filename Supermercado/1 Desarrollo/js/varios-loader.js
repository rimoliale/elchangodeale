...
const rutaPDF = 'Recursos/BD/variosl2.pdf'; // archivo fijo

(async function () {
  const imagenDefault = 'images/Varios.png';
    ...
    productos.forEach((p, idx) => {
      ...
      li.innerHTML = `
        ...
        <div class="astra-shop-summary-wrap">
          <span class="ast-woo-product-category">Varios</span>
